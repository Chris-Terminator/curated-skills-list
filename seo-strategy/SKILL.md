...
description: >
  ...
  MODE 1 — ARTICLE/PAGE SEO: Trigger when the user shares an article, blog post, draft, or single-page URL and mentions SEO, ranking, 
  or Google — or asks to "check", "optimize", "improve", "rewrite", or "polish" content, even without saying SEO. Trigger phrases: "optimize this article", 
  "SEO optimize this", "improve for SEO", "rewrite for SEO", "check this article", "make this rank", "SEO this". When in doubt, activate.

  MODE 2 — FULL WEBSITE AUDIT: Trigger for site-wide SEO audits, multi-page analysis, or domain reviews —
  or when the user provides a root URL and asks for SEO help. Trigger phrases: "audit my site", "SEO strategy for my website",
  "check my website SEO", "full SEO audit", "site SEO", "website SEO review", "SEO health check", "site audit", "domain audit". 
  Crawls multiple pages and produces an HTML report with site-wide analysis, cross-page patterns, architecture review, and prioritized recommendations.
---
